...
import static com.github.alexishuf.fastersparql.client.util.Skip.UNTIL_LF;
...
class TSVParserTest {
    ...
    void testParseSingleFeed(String ignored, String input, @Nullable List<String> vars,
    ...
    @ParameterizedTest @MethodSource("data")
    void testParseSingleFeedAsStringBuilder(String ignored, String input, @Nullable List<String> vars,
                                            @Nullable List<@Nullable String[]> rows) {
        TestConsumer consumer = new TestConsumer();
        TSVParser parser = new TSVParser(consumer);
    ...
    @ParameterizedTest @MethodSource("data")
    void testParseLineFeed(String ignored, String input, @Nullable List<String> vars,
                           @Nullable List<@Nullable String[]> rows) {
        TestConsumer consumer = new TestConsumer();
        TSVParser parser = new TSVParser(consumer);
        for (int last = input.length()-1, start = 0, end; start <= last; start = end) {
            end = skip(input, start, last, UNTIL_LF)+1;
    ...
    @ParameterizedTest @MethodSource("data")
    void testParseLineFeedAsStringBuilder(String ignored, String input, @Nullable List<String> vars,
                                          @Nullable List<@Nullable String[]> rows) {
        TestConsumer consumer = new TestConsumer();
        TSVParser parser = new TSVParser(consumer);
        for (int last = input.length()-1, start = 0, end; start <= last; start = end) {
    ...
    @ParameterizedTest @MethodSource("data")
    void testParseByChar(String ignored, String input, @Nullable List<String> vars,
                         @Nullable List<@Nullable String[]> rows) {
        TestConsumer consumer = new TestConsumer();
        TSVParser parser = new TSVParser(consumer);
    ...
    @ParameterizedTest @MethodSource("data")
    void testParseByCharAsStringBuilder(String ignored, String input, @Nullable List<String> vars,
                                        @Nullable List<@Nullable String[]> rows) {
        TestConsumer consumer = new TestConsumer();
        TSVParser parser = new TSVParser(consumer);
        for (int i = 0, len = input.length(); i < len; i++)
