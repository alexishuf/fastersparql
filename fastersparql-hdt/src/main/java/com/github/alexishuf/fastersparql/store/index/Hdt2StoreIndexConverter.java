...
public class Hdt2StoreIndexConverter {
    private static final Logger log = LoggerFactory.getLogger(Hdt2StoreIndexConverter.class);
    ...
    public @This Hdt2StoreIndexConverter tempDir(Path v)           { this.tempDir = v; return this; }
    public @This Hdt2StoreIndexConverter splitMode(Splitter.Mode v)  { this.splitMode = v; return this; }
    public @This Hdt2StoreIndexConverter validate(boolean v)        { this.validate = v; return this; }
    public @This Hdt2StoreIndexConverter optimizeLocality(boolean v) { this.optimizeLocality = v; return this; }
    public @This Hdt2StoreIndexConverter standaloneDict(boolean v)   { this.standaloneDict = v; return this; }
    ...
    private static final class TriplesAction  extends RecursiveAction {
        ...
        private final class Translator extends RecursiveAction {
            ...
            @Override protected void compute() {
                Dict.AbstractLookup<?> lookup = strings.polymorphicLookup().takeOwnership(this);
                try {
                    for (T t; (t = uninterruptibleTake(raw)) != T_DIE; ) {
                        T translated = recycled.poll();
                        if (translated == null) translated = new T();
                        translated.set(translate(t.s, SUBJECT,   lookup),
                                       translate(t.p, PREDICATE, lookup),
                                       translate(t.o, OBJECT,    lookup));
    ...
    private static final class VisitStringsAction extends RecursiveAction {
        private static final FinalSegmentRope DIE_ROPE = FinalSegmentRope.asFinal("DIE");
        private final int dictId;
