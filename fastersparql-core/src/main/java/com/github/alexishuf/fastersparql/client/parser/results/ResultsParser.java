...
public interface ResultsParser {
    /**
     * Feed the next input of the result's serialization.
     *
     * <p>Methods of the attached {@link ResultsParserConsumer} will be called from within this method
     * if the list of variables becomes known or if a new complete row is parsed.</p>
     *
