...
public class RDFMediaTypes {
    ...
    /**
     * List of media types to include in a Accept headers by default.
     *
     ...
     */
    public static final List<MediaType> DEFAULT_ACCEPTS = Collections.unmodifiableList(Arrays.asList(
            TTL, NT, TRIG, JSONLD, RDFXML));
}
