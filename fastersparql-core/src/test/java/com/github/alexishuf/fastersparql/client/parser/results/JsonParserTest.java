...
class JsonParserTest {
    ...
    /* 26 */    arguments("alice", "uri", noDatatype, "en", "<alice>"),
                // accept ntIRI as an alias to uri
    /* 27 */    arguments("alice", "ntIRI", noDatatype, noLang, "<alice>"),
                // accept ntIRI as an alias to uri, ignore lang
    /* 28 */    arguments("alice", "ntIRI", noDatatype, "en", "<alice>"),
                // accept ntIRI as an alias to uri, ignore datatype
    /* 29 */    arguments("alice", "ntIRI", "http://www.w3.org/2001/XMLSchema#string", noLang, "<alice>"),
