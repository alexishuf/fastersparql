...
class PrefixMapTest {
    ...
    record D(Rope name, Rope unwrappedIri, Rope local, Rope before, Rope after) {
        ...
        public Term complete() { return Term.valueOf(Rope.of('<', unwrappedIri, local, '>')); }
        public Term iriTerm() { return Term.valueOf(Rope.of('<', unwrappedIri,'>')); }
        public Rope iriPrefix() { return Rope.of('<', unwrappedIri); }
