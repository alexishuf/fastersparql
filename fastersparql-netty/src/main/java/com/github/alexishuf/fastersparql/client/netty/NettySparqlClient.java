...
public class NettySparqlClient extends AbstractSparqlClient {
    ...
    @Override public <B extends Batch<B>> BIt<B> query(BatchType<B> batchType, SparqlQuery sp) {
        ...
        try {
            return new QueryBIt<>(sp, batchType);
     ...
     */
    private abstract class ClientBIt<B extends Batch<B>> extends NettySPSCBIt<B> {
        private final HttpRequest request;

        public ClientBIt(BatchType<B> batchType, Vars vars, HttpRequest request) {
            super(batchType, vars, FSProperties.queueMaxBatches());
    ...
    private class QueryBIt<B extends Batch<B>> extends ClientBIt<B> {
        ...
        public QueryBIt(SparqlQuery sparql, BatchType<B> batchType) {
            super(batchType, sparql.publicVars(), createRequest(sparql));
        }
